...
{
    public class ServicioTipoBebidas
    {
        private RepositorioTipoBebidas Repositorio;
        public ServicioTipoBebidas(RepositorioTipoBebidas Repositorio)
        {
        ...
        {
            List<TipoBebidasModel> lista = Repositorio.Listar();
            return lista;
        }
